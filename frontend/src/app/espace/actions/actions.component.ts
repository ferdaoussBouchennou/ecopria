...
import { ActionRowViewModel, ActionSummaryDto, MonInscriptionDto } from '../../core/models/action.model';
...
export class ActionsComponent implements OnInit {
    ...
    this.inscriptionService.getMesActions(this.userId).pipe(
      switchMap((inscriptions) => {
        ...
        return forkJoin(inscriptions.map((inscription) =>
          this.actionService.getDetail(inscription.actionId).pipe(
  ...
  private toRow(action: ActionSummaryDto, inscription: MonInscriptionDto): ActionRowViewModel {
    return {
